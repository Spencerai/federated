...
def zip_two_tuple(input_val, context_stack):
  ...
  unnamed_zip = computation_constructing_utils.drop_names_and_federated_zip_two_tuple(
  ...
  naming_function_intrinsic = computation_constructing_utils.construct_map_or_apply(
      naming_function, unnamed_zip)
  named_zipped = computation_building_blocks.Call(
      naming_function_intrinsic,
      computation_building_blocks.Tuple([naming_function, unnamed_zip]))

  return value_impl.ValueImpl(named_zipped, context_stack)
